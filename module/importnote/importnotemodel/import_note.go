...
var (
	...
	ErrImportNoteHasSameProduct = common.NewCustomError(
		errors.New("import note has duplicate product"),
		"import note has duplicate product",
		"ErrImportNoteHasSameProduct",
	)
